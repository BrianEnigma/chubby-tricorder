...
// #######################################################
// IMAGES BEGIN
// Really, Arduino??? These have to be inline and not in an include file?
...
void loop() {
  Serial.println("image1_1");
  display.clearDisplay();
  display.display();
  display.drawBitmap(0, 0, PROBE1_1, PROBE1_1_WIDTH, PROBE1_1_HEIGHT, WHITE);
  display.display();
  delay(2000);

  Serial.println("image1_2");
  display.clearDisplay();
  display.display();
  display.drawBitmap(0, 0, PROBE1_2, PROBE1_2_WIDTH, PROBE1_2_HEIGHT, WHITE);
  display.display();
  delay(2000);

  Serial.println("image1_3");
  display.clearDisplay();
  display.display();
  display.drawBitmap(0, 0, PROBE1_3, PROBE1_3_WIDTH, PROBE1_3_HEIGHT, WHITE);
  display.display();
  delay(2000);

  Serial.println("image1_4");
  display.clearDisplay();
  display.display();
  display.drawBitmap(0, 0, PROBE1_4, PROBE1_4_WIDTH, PROBE1_4_HEIGHT, WHITE);
  display.display();
  delay(2000);
}
